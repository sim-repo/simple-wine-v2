...
class Product {
    ...
    init(id: Int, name: String, desc: String, price: Double, oldPrice: Double, attributeIds: [Int], imageURL: String, popularity: Int, manufactureYear: Int){
        self.id = id
        self.name = name
        self.desc = desc
        self.price = price
